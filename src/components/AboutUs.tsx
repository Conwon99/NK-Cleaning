          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                ...
                cleaning to specialist biohazard and hoarding work.
              </p>

              <p className="text-lg text-muted-foreground leading-relaxed">
                We work discreetly and professionally, so you can feel comfortable inviting us into your space. 
                Whether it's a regular home clean, an end-of-tenancy, a busy office, or sensitive specialist work, 
                our trained team delivers spotless results and peace of mind.
              </p>
            </div>
