...
const TrustBar = () => {
  const trustItems = [
    ...
    {
      icon: CheckCircle,
      text: "Trained Specialists",
      description: "Professional biohazard & cleaning experts"
    },
    {
      icon: Star,
  ...
  return (
    <section className="py-8 pb-16 px-4 bg-primary/5 border-y border-primary/10 -mt-24">
